...
function initialize() {
  ...
  state.filtersCollapsed = localStorage.getItem("moleculeDashboardFiltersCollapsed") === "true";
  ...
  els.toggleFilters.addEventListener("click", () => {
    ...
    localStorage.setItem("moleculeDashboardFiltersCollapsed", String(state.filtersCollapsed));
